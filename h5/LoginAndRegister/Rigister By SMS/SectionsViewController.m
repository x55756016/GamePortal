...
- (void)viewDidLoad
{
    ...
    table=[[UITableView alloc] initWithFrame:CGRectMake(0, 44+statusBarHeight, self.view.frame.size.width, self.view.bounds.size.height-(statusBarHeight+49)) style:UITableViewStylePlain];
